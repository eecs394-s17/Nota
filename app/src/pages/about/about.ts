...
makePostRequest() {
    ...
    base64image.innerHTML = "<img src='data:image/gif;base64,"+data1.notes+ "'>";
    // this.http.post("http://127.0.0.1:5000/api/v1/notes", data1)
    this.http.post("http://34.209.98.85/api/v1/notes", data1)
        .subscribe(data => {
